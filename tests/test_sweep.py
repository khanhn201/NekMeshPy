...
def hex_nodes(b):
    ...
    nodes, _ = conform.conformal_hex(b.points, b.corners, b._elem_edges, b._edge_flip,
                                     b.quad_mesh.line_mesh.interior, b.hexes, b.orient,
...
def test_a_straight_path_reproduces_extrude(order):
    ...
    assert np.array_equal(sw.corners, ex.corners)
...
def test_quad_rung_sweeps_a_segment_into_an_exact_flat_annulus(order):
    ...
    nodes, _ = conform.conformal_quad(rib.points, rib.corners, rib.quads, rib.orient,
