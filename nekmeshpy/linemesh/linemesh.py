...
from .._typing import BoolArray, FloatArray, IntArray, PointArray, StrArray
...
class LineMesh:
    ...
    def blend(cls, a: LineMesh, b: LineMesh,
        ...
        return [cls((1.0 - t) * A + t * B, a.lines, boundaries=a.boundaries,
    ...
    def merge(cls, meshes: list[LineMesh], *,
        ...
        out = cls(points, lines, etags, bnd, names)
